...
const reqString = `https://data.lacity.org/resource/7fvc-faax.json?${app_token}$limit=1500&$order=date_occ DESC&$select=date_occ, time_occ, crm_cd, vict_age, vict_sex, weapon_used_cd, location_1, location&`;
const radius    = 800;
